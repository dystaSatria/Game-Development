...
public class WaypointManagerWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        SerializeObject obj = new SerializeObject(this);

        EditorGUILayout.PropertyField(obj.FindProperty("waypointOrigin"));

        if(waypointOrigin == null)
        {
            EditorGUILayout.HelpBox("Please assign a Point origin transform", MessageType.Warning);
        }
    ...
    void CreateWaypoint()
    {
        ...
        waypointOrigin.transform.SetParent(waypointOrigin, false);
