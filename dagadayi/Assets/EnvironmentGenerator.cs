...
public class EnvironmentGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(3f, 100)] private int _levelLength = 50;
    ...
    private void OnValidate()
    {
        ...
        {   //Mathimatical concept 
            ...
            if( i != 0 && i != _levelLength - 1)
            {
                ...
                //for to not sharp land
                _spriteShapeController.spline.SetLeftTangent(i, Vector3.left * _xMultiplier * _curveSmoothness);
                _spriteShapeController.spline.SetRightTangent(i, Vector3.left * _xMultiplier * _curveSmoothness);
